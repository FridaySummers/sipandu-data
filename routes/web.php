...
use App\Http\Controllers\OpdRowController;
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/opd/rows', [OpdRowController::class, 'index'])->name('opd.rows');
    Route::post('/opd/rows', [OpdRowController::class, 'store'])->name('opd.rows.store');
    Route::put('/opd/rows/{row}', [OpdRowController::class, 'update'])->name('opd.rows.update');
    Route::delete('/opd/rows/{row}', [OpdRowController::class, 'destroy'])->name('opd.rows.destroy');
    ...
    Route::get('/ketahanan-pangan/rows', [DataManagementController::class, 'ketahananPanganRows']);
    Route::post('/ketahanan-pangan/rows', [DataManagementController::class, 'ketahananPanganStoreRow']);
    Route::put('/ketahanan-pangan/rows/{row}', [DataManagementController::class, 'ketahananPanganUpdateRow']);
    Route::delete('/ketahanan-pangan/rows/{row}', [DataManagementController::class, 'ketahananPanganDestroyRow']);
