# Membuat file utils.js
utils_js = '''// SIPANDU DATA - Utility Functions
...
# Simpan file utils.js
with open('utils.js', 'w', encoding='utf-8') as f:
    f.write(utils_js)

print("✅ utils.js created successfully")
print("🔧 Comprehensive utility functions untuk date, number, string, array, storage, DOM, file, validation, dan performance")