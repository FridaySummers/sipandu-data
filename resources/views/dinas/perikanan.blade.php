...
@section('content')
    <div class="page active" id="perikanan-page">
      ...
      <div class="card fk-card">
          ...
          <div class="card-actions"><button class="btn btn-outline btn-sm" id="fk-export"><i class="fas fa-download"></i> Export</button> <button class="btn btn-outline btn-sm" id="fk-add"><i class="fas fa-plus"></i> Ajukan Data</button></div>
        </div>
        <div class="card-body">
...
function mapInf(data){return (Array.isArray(data)?data:[]).map(function(r){var v=r.values||{};return {id:r.id,uraian:r.uraian,y2019:v.y2019||'',y2020:v.y2020||'',y2021:v.y2021||'',y2022:v.y2022||'',y2023:v.y2023||''};});}
function mapAlt(data){return (Array.isArray(data)?data:[]).map(function(r){var v=r.values||{};return {id:r.id,kat:v.kat||'',jenis:v.jenis||'',y2019:v.y2019||'',y2020:v.y2020||'',y2021:v.y2021||'',y2022:v.y2022||'',y2023:v.y2023||''};});}
function mapStd(data){return (Array.isArray(data)?data:[]).map(function(r){var v=r.values||{};return {id:r.id,uraian:r.uraian,y2019:v.y2019||'',y2020:v.y2020||'',y2021:v.y2021||'',y2022:v.y2022||'',y2023:v.y2023||''};});}
