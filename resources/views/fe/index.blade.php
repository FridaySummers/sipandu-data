            ...
            <div class="nav-container">
                ...
                <div class="nav-menu" id="nav-menu">
                    <ul class="nav-list">
                        ...
                        <li><a href="{{ url('/fe/login') }}" class="nav-link btn-primary">Masuk Aplikasi</a></li>
                    </ul>
                </div>
        ...
        <div class="hero-container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    <a href="{{ url('/fe/login') }}" class="btn btn-primary"><i class="fas fa-sign-in-alt"></i>Masuk Aplikasi</a>
                    <a href="#about" class="btn btn-secondary"><i class="fas fa-info-circle"></i>Pelajari Lebih Lanjut</a>
                </div>
            </div>
            <div class="hero-image"><div class="hero-graphic"><i class="fas fa-laptop-code"></i></div></div>
        </div>
    </section>
        ...
        <div class="container">
            ...
            <div class="about-grid">
                ...
                <div class="about-features">
                    ...
                    <div class="feature-item"><i class="fas fa-target"></i><h4>Tujuan</h4><p>RKPD berbasis data akurat dan terkini</p></div>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="cta">
        <div class="container">
            <div class="cta-content">
                ...
                <a href="{{ url('/fe/login') }}" class="btn btn-primary"><i class="fas fa-arrow-right"></i>Akses SIPANDU DATA</a>
            </div>
        </div>
    </section>
    ...
    <footer class="footer">
        <div class="container">
            <div class="footer-content">
                <div class="footer-brand"><div class="footer-logo"><i class="fas fa-chart-line"></i><span>SIPANDU DATA</span></div><p>Sistem Pemantauan dan Update Data Perencanaan<br>Kabupaten Kolaka Utara</p></div>
