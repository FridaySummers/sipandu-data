...
@section('content')
    <div class="page active" id="dashboard-page">
            ...
            <div class="kpi-grid">
                <div class="kpi-card"><div class="kpi-icon"><i class="fas fa-building"></i></div><div class="kpi-content"><div class="kpi-number" id="total-dinas">12</div><div class="kpi-label">Total Dinas</div><div class="kpi-trend positive"><i class="fas fa-arrow-up"></i><span>+0%</span></div></div></div>
                <div class="kpi-card"><div class="kpi-icon success"><i class="fas fa-check-circle"></i></div><div class="kpi-content"><div class="kpi-number" id="complete-data">6</div><div class="kpi-label">Data Complete</div><div class="kpi-trend positive"><i class="fas fa-arrow-up"></i><span>+2</span></div></div></div>
                <div class="kpi-card"><div class="kpi-icon warning"><i class="fas fa-percentage"></i></div><div class="kpi-content"><div class="kpi-number" id="avg-progress">70%</div><div class="kpi-label">Rata-rata Progress</div><div class="kpi-trend positive"><i class="fas fa-arrow-up"></i><span>+5%</span></div></div></div>
                <div class="kpi-card"><div class="kpi-icon info"><i class="fas fa-clock"></i></div><div class="kpi-content"><div class="kpi-number" id="pending-reviews">8</div><div class="kpi-label">Pending Reviews</div><div class="kpi-trend negative"><i class="fas fa-arrow-down"></i><span>-2</span></div></div></div>
            </div>
